...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x02A8E585466cD8dF0642423AEAF04d1a1C17014C')).toBe('0x02A8E585466cD8dF0642423AEAF04d1a1C17014C')
      expect(isAddress('0x02A8E585466cD8dF0642423AEAF04d1a1C17014C')).toBe('0x02A8E585466cD8dF0642423AEAF04d1a1C17014C')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0x02A8E585466cD8dF0642423AEAF04d1a1C17014C')
    })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x02A8E585466cD8dF0642423AEAF04d1a1C17014C')).toBe('0xf164...b92a')
    })
